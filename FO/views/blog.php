                ...
                foreach ($listeArticles as $row) {
                    ...
                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry align-self-stretch">
                            <a href="blog-single.php?id=<?PHP echo $row['id']; ?>" class="block-20"
                               style="background-image: url(<?PHP echo '../../BO/views/pages/Blog/uploads/' . $row['image']; ?>); width: 300px"></a>
                            <div class="text py-4 d-block">
                                <div class="meta">
                                    <div><a href="#"><?PHP echo $row['date']; ?></a></div>
                                </div>
                                <h3 class="heading mt-2"><a
                                            href="blog-single.php?id=<?PHP echo $row['id']; ?>"><?PHP echo $row['titre']; ?></a>
                                </h3>
